(function () {
    ...
    function startGame() {
        ...
        if(dangerInfo.visible && hasColission(carInfo, dangerInfo)) {
            return finishGame();
        }
        ...
        if(coinInfo.visible && hasColission(carInfo, coinInfo)) {
            score++;
        ...
        if(arrowInfo.visible && hasColission(carInfo, arrowInfo)) {
